...
start_idx = text.find("void MainWindow::setup_ui() {")
end_idx = text.find("void MainWindow::connect_signals() {")

if start_idx == -1 or end_idx == -1:
    print("Could not find boundaries")
    sys.exit(1)

replacement = """void MainWindow::setup_ui() {
    ...
    QLabel* search_label = new QLabel("💬 FluentNav UI"); 
    ...
    QLabel* banner_title = new QLabel("FluentUI Chat Experience");
    banner_title->setStyleSheet("font-size: 30px; font-weight: 800; color: #1a1a1a; background: transparent;");
    QLabel* banner_subtitle = new QLabel("Recent updates and modern controls incorporated in chat.\\nSelect a conversation to begin.");
